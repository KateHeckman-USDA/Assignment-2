...
# There are several numerical columns that need covered from 'chr'
df <- df %>% mutate(Dollars = as.numeric(gsub("$", "", Dollars)))
          # mutate('Dollars 2 years ago' = as.numeric('Dollars 2 years ago')) %>% 
          # mutate('Volume sales 2 years ago' = as.numeric('Volume sales 2 years ago')) %>% 
          # mutate('Unit sales 2 years ago' = as.numeric('Unit sales 2 years ago')) %>% 
          # mutate('Percent change dollars 2 years' = as.numeric('Percent change dollars 2 years')) %>% 
          # mutate('Percent change units 2 years' = as.numeric('Percent change units 2 years')) %>% 
          # mutate('Percent change volume 2 years' = as.numeric('Percent change volume 2 years')))
