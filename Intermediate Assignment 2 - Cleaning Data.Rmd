...
# I cast the missing values to "NA" when coverting the column to numeric
```
...
alcoholSpending <- df %>% group_by(State, Year) %>% summarize(yearlySpending = sum(Dollars))
AL2020 <- filter(alcoholSpending, State == "Alabama" & Year == 2020)
